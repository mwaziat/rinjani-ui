...
export const checkboxProps: PropRow[] = [
  {
    ...
    required: true,
    default: "—",
    description: "Array of { label, value, disabled? } checkbox options.",
  },
  {
    name: "values",
    type: "(string | number)[]",
    required: true,
    default: "—",
    description: "Array of currently checked values.",
  },
  {
    name: "onChange",
    ...
    required: true,
    default: "—",
    description: "Callback with the new array of checked values.",
  },
  {
    name: "label",
    type: "ReactNode",
  ...
  },
  {
    ...
    type: '"col" | "row"',
    default: '"col"',
    description: "Stack checkboxes vertically or side-by-side.",
  },
  {
    name: "color",
